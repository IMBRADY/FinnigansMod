...
public class IxeProjectileRenderer extends EntityRenderer<IxeProjectileEntity> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(TommeMod.MOD_ID, "textures/entity/ixe_projectile.png");
    private static final float SCALE = 0.5F;

    public IxeProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(IxeProjectileEntity entity) {
        return TEXTURE;
    }

    @Override
    public void render(IxeProjectileEntity entity, float entityYaw, float partialTicks, PoseStack poseStack,
