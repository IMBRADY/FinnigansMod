...
public class SyncReputationPacket {
    ...
    public SyncReputationPacket(int entityId, CompoundTag data) {
    ...
    public void handle(Supplier<NetworkEvent.Context> ctxSupplier) {
        ...
        ctx.enqueueWork(() -> {
            ...
            if (e != null) {
                e.getCapability(ModReputationCapabilities.REPUTATION_HANDLER).ifPresent(h -> h.deserializeNBT(data));
            }
        });
