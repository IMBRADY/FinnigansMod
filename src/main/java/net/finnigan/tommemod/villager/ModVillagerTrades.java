...
public class ModVillagerTrades {
    ...
    public static void addTrades(VillagerTradesEvent event) {
        if (event.getType() == ModVillagers.BEEKEEPER.get()) {
            ...
            // Level 1 - buys flowers, sells honey
            ...
            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 4), new ItemStack(Items.HONEY_BOTTLE, 1), 16, 1, 0.05F));

            // Level 2 - buys bee nests + more flowers, sells honeycomb
            ...
            // Level 3 - sells stingers and bee wings
            ...
            trades.get(3).add((trader, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 12), new ItemStack(ModItems.BEE_WINGS.get(), 2), 12, 10, 0.05F));

            // Level 4 - sells bee-nade and better buzz
            trades.get(4).add((trader, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 3), new ItemStack(ModItems.BEE_NADE.get(), 1), 8, 15, 0.05F));
            trades.get(4).add((trader, random) -> new MerchantOffer(
